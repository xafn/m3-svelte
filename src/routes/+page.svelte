	...
	<div>
		<Dialogue bind:open={modalOpen}>
			...
			<svelte:fragment slot="description">
				Dear reader, hope you have a wonderful day. And your tomorrow will be even better. First I have
				to make an excuse for my bad writing skills. I hope you are fine with some mistakes as
